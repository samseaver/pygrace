...
from PyGrace.drawing_objects import DrawingObject
from PyGrace.dataset import DataSet, SYMBOLS, INDEX2SYMBOLS, LINESTYLES, \
    INDEX2LINESTYLES
from PyGrace.axis import Axis,LINEAR_SCALE,LOGARITHMIC_SCALE
import math
